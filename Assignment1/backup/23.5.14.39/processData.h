...
public:
	...
	void SetCandle(long TIME, float OP, float HP, float LP, float CP);
};
...
public:
	...
	bool isTime(string);
	bool isValue(string);
	bool isCandle(string, string, string, string, string, long &, float &, float &, float &, float &);
